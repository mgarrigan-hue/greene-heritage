...
| 13 | William Greene candidates (PARTIAL) | Captured: 2 Mountmellick 1909/1910 deaths age 66/67 (b.~1843) — both cide-5027279/cide-5096314, may be same person; 2 Mountmellick 1868 marriages (× Catherine Costigan, × Eliza Woods, one day apart); 1878 Mountmellick death age 65 (too old). NLI Portarlington baptism pages 142-145 browsed but Thomas's ~Jul 1870 baptism not yet extracted. Synthesis added to family.json Phase 17. NEXT: extract all 5 register images. | Jun 2026 |
| 14 | Patrick Clarke Snr exact death (PARTIAL) | Captured: 1901 Drogheda age 68 (b.~1833) record cide-4468003 — only IG.ie candidate from 8-query sweep. Age fits chronology (Rose b.1878 → 45; Agnes b.1896 → 63) but implies ~28-yr age gap from Catherine (~40 in 1901). Also captured 2 Agnes Clarke birth candidates (1894 + 1895 Drogheda). Synthesis added to family.json Phase 17. NEXT: extract cide-4468003 register image to confirm address/wife. | Jun 2026 |
